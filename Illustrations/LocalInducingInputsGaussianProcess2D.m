function [mu, var, max_set_length, I]=LocalInducingInputsGaussianProcess2D(x,y,x_s,Omega,N_u1,N_u2,sigma_SE,l_SE,r,sigma_y)
...
[set1, set2, xu_set]=find_set(x_s(:,t),Omega,l_u1,l_u2,N_u1,N_u2,x1_u,x2_u,r);
